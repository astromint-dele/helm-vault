...
import { PRESETS, goToVault } from "../lib/vaultFactory.js";
...
// has no dependency on which vault (if any) is currently being viewed. Which vaults a
// connected wallet already owns lives in VaultSwitcher, not duplicated here, one lookup
// instead of two components independently reading the same registry.
